...
class Document(StanzaObject):
    ...
    @property
    def pos_score(self):
        """ Access the POS score of this document. """
        return self._pos_score

    @pos_score.setter
    def pos_score(self, value):
        """ Set the POS score for this document. """
        self._pos_score = value

    @property
    def lemma_score(self):
        """ Access the lemma score for this document. """
        return self._lemma_score

    @lemma_score.setter
    def lemma_score(self, value):
        """ Set the lemma score for this document. """
        self._lemma_score = value

    @property
    def depparse_score(self):
        """ Access the depparse score for this document. """
        return self._depparse_score

    @depparse_score.setter
    def depparse_score(self, value):
        """ Set the depparse score for this document. """
        self._depparse_score = value
    ...
    def set(self, fields, contents, to_token=False, to_sentence=False, to_document=False):
        ...
        if to_sentence:
            ...
            for field, content in zip(fields, contents):
                ...
                assert getattr(self, field) == content
        else:
    ...
    def to_dict(self):
        ...
        """
        # TODO: eventually we will incorporate the document-level information too
        # Rather than just returning a list of sentences
        # It will be an actual dict with fields such as pos_score, lemma_score, sentences
        ...
        return json.dumps(
                {
                    ...
                    'depparse_score': self.depparse_score,
    ...
    def to_serialized(self):
        ...
        """
        return pickle.dumps((self.text, self.to_dict(), self.pos_score, self.lemma_score, self.depparse_score))
    ...
    def from_serialized(cls, serialized_string):
        ...
        """
        try:
            text, sentences, pos_score, lemma_score, depparse_score = pickle.loads(serialized_string)
            doc = cls(sentences, text)
            doc.build_ents()
            doc.pos_score = pos_score
            doc.lemma_score = lemma_score
            doc.depparse_score = depparse_score
            return doc
        except:
